...
const Hero = () => {
    return <Box m={"2rem 0"}>
        <Text as={"span"} color={"deeppink"} fontSize={"3xl"} >Hi, my name is</Text>
        <Heading as={"h1"} fontSize={"5xl"}>Patryck Golebiewski</Heading>
        <Text as={"span"} color={"gray.300"} fontSize={"2xl"}>I'm into building stuff for the web.</Text>
        ...
        <Box m={"2rem 0"}>
            <Text as={"span"} color={"deeppink"} fontSize={"1xl"}>Things to do while your here!</Text>
            <List m={"1rem 0"} spacing={"1rem"}>
                <ListElement>
                    <ListIcon as={IoMdBuild}/>
                    <Anchor to={"/project"} text={"Check out my Projects"}><ArrowForwardIcon /></Anchor>
                </ListElement>
                <ListElement>
                    <ListIcon as={FaBook}/>
