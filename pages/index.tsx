			...
			<List as={"ul"} w={"100%"}>
				<ProjectListItem>
					<FeaturedProject
						name={"Coursor"}
						description={
							"Course management dashboard for students and professors. It incorporates session using cookies,\n" +
				...
				<ProjectListItem>
					<FeaturedProject
						name={"Expensie"}
						description={
							"Desktop CRUD application built on Electron that assists in the tracking of sales and expenses, " +
				...
				<ProjectListItem>
					<FeaturedProject
						name={"Waste Less"}
						description={
							"Inventory solution for consumers to track whats fresh, spoiled and what they need to restock on."
						}
						image={WasteLess}
